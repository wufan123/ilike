    ...
    return (
      <View style={styles.page}>
        ...
        <View style={styles.view}>
          <UselessTextInput  keyboardType='default'  style={{textAlignVertical: 'top'}} placeholder='恶心自己成全别人，来吐槽吧~' multiline={true} numberOfLines={8} />
          ...
          <Image source={require('../../assets/me/ff.png')} style={{width: 60, height: 60}} resizeMode='contain' />
           </TouchableOpacity>
        </View>
